...
Vue.use(axios);
import NavigationBar from '../template/AppNavbar.vue'
...
export default {
   ...
   methods: {
        ...
        getdetail(id_siswa){
            axios.get('http://127.0.0.1:8000/api/detailsiswa/' + id_siswa)
            .then((response) => {
        ...
        save_edit: function(){
            ...
            .then(
              res => {
                swal({
                    title: "Sukses Menambahkan Siswa",
                    text: "Siswa Telah Ditambahkan,Silakan kembali ke Data anggota",
                    icon: "success",
                    button: "Kembali",
                    });
                console.log(res)
