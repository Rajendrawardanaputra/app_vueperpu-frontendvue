                              ...
                              <table class="table table-bordered">
                                  ...
                                  <tbody>
                                      <tr v-for="s in siswa" :key="s.id_siswa">
                                          ...
                                          <td>
                                              <div class="btn-group">
                                                  <router-link :to="{path: '/updatesiswa/'+s.id_siswa}" class="btn btn-primary"> Edit </router-link>  
  ...
  methods : {
      ...
      remove(s) {
          ...
          swal({
            ...
            text: "kalo sudah dihapus engga bisa dikembalikan lagi loh",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            })
            .then((willDelete) => {
            if (willDelete) {
                swal("yahhhh,berhasil dihapus dong", {
                icon: "success",
                });
            } else {
